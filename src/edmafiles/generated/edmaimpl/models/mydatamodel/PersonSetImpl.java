...
import edmafiles.generated.mydatamodel.kinds.person.PersonFilter;
...
import edmafiles.generated.valuedomains.mydatamodel.impl.PersonListImpl;
...
public class PersonSetImpl implements PersonSet
{
    ...
    public PersonSet filter(PersonFilter filter)
    {
        ...
        return new edmafiles.generated.edmaimpl.models.mydatamodel.PersonSetImpl(newSetID, edma_dmview);
    }
