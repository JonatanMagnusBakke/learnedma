package edmafiles.generated;

import edmafiles.generated.edmaimpl.models.mydatamodel.MyDataModelFactoryImpl;
...
public class learnemda
{
    ...
    public static IMetaEnvironment generateEnvironment()
    {
        ...
        MetaEnvironment edma_environment = new MetaEnvironment("learnemda");
        {
            MetaDataModel edma_model = new MetaDataModel("MyDataModel", "learnemda");
            ...
            //Views:
            {
                MetaMethod view = new MetaMethod("getAllPersons", "View all Persons");
                view.addOutputParameter("personList", "PersonList", false);
                edma_model.addView(view);
            }
            {
                MetaMethod view = new MetaMethod("getAllCourses", "View all Courses");
                view.addOutputParameter("courseList", "CourseList", false);
                edma_model.addView(view);
            }
            {
                MetaMethod view = new MetaMethod("getCourseStudents", "View all Students on Course");
                view.addInputParameter("courseID", "CourseID", false);
                view.addOutputParameter("studentList", "PersonList", false);
                edma_model.addView(view);
            }
            {
                MetaMethod view = new MetaMethod("getCourseTeacher", "View Teacher for Course");
                view.addInputParameter("courseID", "CourseID", false);
                view.addOutputParameter("teacher", "Teacher", true);
                edma_model.addView(view);
            }
            ...
            {
                MetaMethod action = new MetaMethod("assignStudentToCourse", "Assigns a Student to a Course");
                action.addInputParameter("studentID", "PersonID", false);
                action.addInputParameter("courseID", "CourseID", false);
                edma_model.addAction(action);
            }
            {
                MetaMethod action = new MetaMethod("assignTeacherToCourse", "Assigns the Teacher for the Course");
     ...
     */
    public learnemda(IRuntimeFactory factory)
    {
