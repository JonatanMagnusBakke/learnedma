 ...
 * 
 */
public class RemoteGetCourseStudentsResult implements GetCourseStudentsResult
{
     ...
     */
    public RemoteGetCourseStudentsResult(int edma_errorCode, String edma_errorMsg, String edma_errorDesc, PersonList studentList)
    {
